...
static void usage(FILE *f) {
    fprintf(f,
        ...
        "Examples:\n"
        "  probe -p 1234 -w metric.alpha:f32:0x7ffd01234000 -n 1\n"
        "  probe -p 1234 -s metric.alpha:f32:metric_alpha -n 10 -i 100\n"
        "  probe run --symbol metric.alpha=f32:metric_alpha -- ./program\n"
        "  probe attach --pid 1234 --symbol metric.alpha=f32:metric_alpha\n"
        "  probe -s metric.alpha:f32:metric_alpha -n 10 -i 100 -- ./program\n"
        "  probe symbols ./program\n"
        "  probe symbols ./program --filter metric\n"
        "  probe symbols ./program --demangle\n"
        "  probe symbols ./program --types\n\n"
        "  probe plan --watch metric.alpha=f32@symbol:metric_alpha -- ./program\n\n"
        "Options:\n"
        ...
        "Planned:\n"
        "  DWARF field paths such as state.metric.alpha:f32 are reserved\n"
